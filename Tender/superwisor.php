...
{
	$query="INSERT INTO `login`(`employee_code`, `name`, `email`, `phone`, `password`,`is_superwisor`) VALUES ('".$_GET['txt_employee_code']."','".$_GET['txt_name']."','".$_GET['txt_email']."','".$_GET['txt_phone']."','".$_GET['txt_password']."','".$_GET['is_active']."')";
	//echo $query;
            ...
            <div class="row">
				...
				<h1> Create Superwisor</h1><br>
                    <form role="form" method="get">
						...
						<div class="form-group">
							<label>is superwisor&nbsp </label><br>
						...
						<div class="col-lg-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Superwisors List :</h3>
								</div>
...
var traffic = [
	<?php
		$result = (mysqli_query($conn,"SELECT * FROM `login` where is_superwisor = 1"));
